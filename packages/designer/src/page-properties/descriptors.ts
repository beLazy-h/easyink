...
const WATERMARK_ENABLED_DESCRIPTOR: PagePropertyDescriptor = {
  ...
  label: 'designer.pageLayer.textWatermarkEnabled',
  persisted: 'schema',
  editor: 'switch',
  read(ctx) {
...
const WATERMARK_TEXT_DESCRIPTOR: PagePropertyDescriptor = {
  ...
  label: 'designer.pageLayer.textWatermarkText',
  persisted: 'schema',
  editor: 'text',
...
const WATERMARK_ROTATION_DESCRIPTOR: PagePropertyDescriptor = {
  ...
  label: 'designer.pageLayer.textWatermarkRotation',
  persisted: 'schema',
  editor: 'number',
  min: -180,
  max: 180,
...
const WATERMARK_OPACITY_DESCRIPTOR: PagePropertyDescriptor = {
  ...
  label: 'designer.pageLayer.textWatermarkOpacity',
  persisted: 'schema',
  editor: 'number-slider',
  min: 0,
  max: 100,
...
const WATERMARK_FONT_SIZE_DESCRIPTOR: PagePropertyDescriptor = {
  ...
  label: 'designer.pageLayer.textWatermarkFontSize',
  persisted: 'schema',
  editor: 'number',
  min: 1,
  max: 500,
...
const WATERMARK_GAP_DESCRIPTOR: PagePropertyDescriptor = {
  ...
  label: 'designer.pageLayer.textWatermarkGap',
  persisted: 'schema',
  editor: 'number',
  min: 1,
  max: 2000,
...
const WATERMARK_COLOR_DESCRIPTOR: PagePropertyDescriptor = {
  ...
  label: 'designer.pageLayer.textWatermarkColor',
  persisted: 'schema',
  editor: 'color',
  visible: isTextWatermarkEnabled,
  read(ctx) {
