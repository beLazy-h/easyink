...
import type { AssistantPluginSelection, AssistantPluginSelectionEntry } from '@hcxz/assistant-plugins'
import type { AssistantConversationRecord, AssistantEventRecord, AssistantTaskRecord } from '@hcxz/assistant-store'
...
import { IconBot, IconHistory, IconPanelMaterials, IconPlus } from '@hcxz/icons'
