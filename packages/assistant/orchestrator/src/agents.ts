...
import type { AssistantMaterialManifest, AssistantTaskInput, AssistantValidationIssue } from '@hcxz/assistant-capabilities'
import type { LLMClient } from '@hcxz/assistant-llm'
import type { AssistantStore } from '@hcxz/assistant-store'
import type { DocumentSchema, ExpectedDataSource, ExpectedField } from '@hcxz/schema'
import type { PromptContext } from './prompts'
import { buildAssistantPluginContext } from '@hcxz/assistant-plugins'
import { formatSchemaValidationIssue, isValidSchema, validateSchemaIssues } from '@hcxz/schema'
import { normalizeAllFieldPaths, SchemaValidator } from '@hcxz/schema-tools'
import { z } from 'zod'
import {
