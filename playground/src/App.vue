...
import type { DataSourceDescriptor, DesignerRuntimeConfig, DocumentSchema } from '@hcxz/designer'
import type { SampleTemplateEntry } from '@hcxz/samples'
import type { StoredTemplate } from './storage/template-store'
import { createAssistantContribution, createBrowserAssistantLLMConfigService } from '@hcxz/assistant-designer-bridge'
...
import { createLocalStoragePreferenceProvider, EasyInkDesigner } from '@hcxz/designer'
import { enUS, zhCN } from '@hcxz/designer/locale'
import { blankA4Template, flowInvoiceTemplate, invoiceDemoData, sampleDataSources } from '@hcxz/samples'
